    ...
    selectQuery: function(tableName, options) {
      ...
      options.attributes = options.attributes && options.attributes.map(function(attr) {
        if (Array.isArray(attr) && attr.length === 2) {
          ...
          return options.table.split(', ')[0] + '.' + QueryGenerator.addQuotes(attr)
        }
      }).join(", ")
      ...
      if (options.include) {
        ...
        options.include.forEach(function(include) {
          var attributes = Object.keys(include.daoFactory.attributes).map(function(attr) {
            ...
            if( Object.prototype.toString.call( include.attributes ) === '[object Array]' ) {
              return (include.attributes.indexOf(attr) == -1) ? undefined : template({ as: include.as, attr:  attr })
            } else {
